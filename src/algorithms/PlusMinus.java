...
public class PlusMinus
{
	 ...
	 * 
	 * Note: This challenge introduces precision problems. The test cases are scaled to six decimal places, though answers with absolute error of up to are
	 * acceptable.
	 * 
	 * Example
	 * 
